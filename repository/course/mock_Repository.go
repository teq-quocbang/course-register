...
func (_m *MockRepository) Create(_a0 context.Context, _a1 *model.Course) error {
...
func (_c *MockRepository_Create_Call) Run(run func(_a0 context.Context, _a1 *model.Course)) *MockRepository_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*model.Course))
	})
	return _c
}
...
func (_c *MockRepository_Create_Call) RunAndReturn(run func(context.Context, *model.Course) error) *MockRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetByID provides a mock function with given fields: ctx, courseID
func (_m *MockRepository) GetByID(ctx context.Context, courseID string) (model.Course, error) {
	ret := _m.Called(ctx, courseID)

	var r0 model.Course
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (model.Course, error)); ok {
...
//   - ctx context.Context
//   - courseID string
func (_e *MockRepository_Expecter) GetByID(ctx interface{}, courseID interface{}) *MockRepository_GetByID_Call {
	return &MockRepository_GetByID_Call{Call: _e.mock.On("GetByID", ctx, courseID)}
}

func (_c *MockRepository_GetByID_Call) Run(run func(ctx context.Context, courseID string)) *MockRepository_GetByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *MockRepository_GetByID_Call) Return(_a0 model.Course, _a1 error) *MockRepository_GetByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRepository_GetByID_Call) RunAndReturn(run func(context.Context, string) (model.Course, error)) *MockRepository_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// GetListBySemester provides a mock function with given fields: ctx, semesterID
func (_m *MockRepository) GetListBySemester(ctx context.Context, semesterID string) ([]model.Course, error) {
...
func (_c *MockRepository_GetListBySemester_Call) Return(_a0 []model.Course, _a1 error) *MockRepository_GetListBySemester_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRepository_GetListBySemester_Call) RunAndReturn(run func(context.Context, string) ([]model.Course, error)) *MockRepository_GetListBySemester_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: _a0, _a1
func (_m *MockRepository) Update(_a0 context.Context, _a1 *model.Course) error {
	ret := _m.Called(_a0, _a1)
...
func (_c *MockRepository_Update_Call) Run(run func(_a0 context.Context, _a1 *model.Course)) *MockRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*model.Course))
	})
	return _c
...
func (_c *MockRepository_Update_Call) RunAndReturn(run func(context.Context, *model.Course) error) *MockRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
